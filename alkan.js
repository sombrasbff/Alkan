...
(function (root) {
    ...
    alkan.drawCourse = function (day, time, courseCode, sectionName, room, color) {
        var y,
            sp,
            id,
    ...
    alkan.setConfig = function (config) {
        var i,
            j;
        for (i in config) {
    ...
    alkan.repaint = function () {
        var i;
        alkan.init();
        save = false;
        for (i in history) {
            i > -1 && alkan.drawCourse.apply(undefined, history[i].args);
        }
        save = true;
    };

    alkan.remove = function (id) {
        var i;
        for (i in history) {
    ...
    alkan.getHistory = function () {
        return history;
    };

    alkan.getCourse = function (id) {
        var i;
        for (i in history) {
    ...
    alkan.updateCourse = function (id, args) {
        var i;
        for (i in history) {
    ...
    alkan.downloadSchedule = function (e) {
