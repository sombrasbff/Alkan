(function (root) {
    ...
    add_button.onclick = function(){
        ...
        id = alkan.drawCourse(_day, time, courseCode.value, sectionName.value, room.value, '#' + document.getElementById('schedBgColor').value);
        ...
        document.getElementById('course_list').innerHTML += "<li>" + string + "<button class='x_button' onclick='alkan.remove(\"" + id + "\");this.parentNode.parentNode.removeChild(this.parentNode);'>X</button></li>";
